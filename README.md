...
main
│   │   └── CallIncomingPage.jsx     # (현주)
│   │   └── CallEndedPage.jsx        # (현주)
│   ├── HomePage.jsx                # 메인 홈 페이지
│   ├── IdolDetail.jsx              # 아이돌 상세 페이지
│   ├── HomePage.jsx                # 메인 홈 페이지 (가현)
│   ├── IdolDetail.jsx              # 아이돌 상세 페이지 (지은)
...
=======
│   ├── Review.jsx                  # 리뷰 페이지 (지은)
│   └── Search.jsx                  # 아이돌 검색 결과 페이지 (지은)
>>>>>>> 0db80bc3045b24e1117a556a6f2144996ab6f60c
